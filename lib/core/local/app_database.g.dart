...
class $CachedPackingsTable extends CachedPackings
    with TableInfo<$CachedPackingsTable, CachedPacking> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $CachedPackingsTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _nameMeta = const VerificationMeta('name');
  @override
  late final GeneratedColumn<String> name = GeneratedColumn<String>(
      'name', aliasedName, false,
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'cached_packings';
  @override
  VerificationContext validateIntegrity(Insertable<CachedPacking> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('name')) {
  ...
  Set<GeneratedColumn> get $primaryKey => {name};
  @override
  CachedPacking map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  $CachedPackingsTable createAlias(String alias) {
    return $CachedPackingsTable(attachedDatabase, alias);
  }
}

class CachedPacking extends DataClass implements Insertable<CachedPacking> {
  final String name;
  final String? description;
  final DateTime createdAt;
  final DateTime updatedAt;
  ...
  CachedPackingsCompanion toCompanion(bool nullToAbsent) {
    return CachedPackingsCompanion(
      name: Value(name),
      description: description == null && nullToAbsent
          ? const Value.absent()
          : Value(description),
  ...
  factory CachedPacking.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return CachedPacking(
      name: serializer.fromJson<String>(json['name']),
  ...
  CachedPacking copyWithCompanion(CachedPackingsCompanion data) {
    return CachedPacking(
      name: data.name.present ? data.name.value : this.name,
      description:
          data.description.present ? data.description.value : this.description,
  ...
  @override
  String toString() {
    return (StringBuffer('CachedPacking(')
          ..write('name: $name, ')
          ..write('description: $description, ')
          ..write('createdAt: $createdAt, ')
          ..write('updatedAt: $updatedAt')
...
class CachedPackingsCompanion extends UpdateCompanion<CachedPacking> {
  final Value<String> name;
  final Value<String?> description;
  final Value<DateTime> createdAt;
  final Value<DateTime> updatedAt;
  final Value<int> rowid;
  const CachedPackingsCompanion({
    this.name = const Value.absent(),
    this.description = const Value.absent(),
    this.createdAt = const Value.absent(),
    this.updatedAt = const Value.absent(),
  ...
  static Insertable<CachedPacking> custom({
    Expression<String>? name,
    Expression<String>? description,
    Expression<DateTime>? createdAt,
    Expression<DateTime>? updatedAt,
  ...
  CachedPackingsCompanion copyWith(
      {Value<String>? name,
      Value<String?>? description,
      Value<DateTime>? createdAt,
      Value<DateTime>? updatedAt,
  ...
  @override
  String toString() {
    return (StringBuffer('CachedPackingsCompanion(')
          ..write('name: $name, ')
          ..write('description: $description, ')
          ..write('createdAt: $createdAt, ')
          ..write('updatedAt: $updatedAt, ')
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $CachedPackingsTable cachedPackings = $CachedPackingsTable(this);
...
typedef $$CachedCategoriesTableProcessedTableManager = ProcessedTableManager<
    ...
    CachedCategory,
    PrefetchHooks Function()>;
typedef $$CachedPackingsTableCreateCompanionBuilder = CachedPackingsCompanion
    Function({
  required String name,
  Value<String?> description,
  Value<DateTime> createdAt,
...
typedef $$CachedPackingsTableUpdateCompanionBuilder = CachedPackingsCompanion
    Function({
  Value<String> name,
  Value<String?> description,
  Value<DateTime> createdAt,
...
class $$CachedPackingsTableFilterComposer
    extends Composer<_$AppDatabase, $CachedPackingsTable> {
  $$CachedPackingsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$CachedPackingsTableOrderingComposer
    extends Composer<_$AppDatabase, $CachedPackingsTable> {
  $$CachedPackingsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$CachedPackingsTableAnnotationComposer
    extends Composer<_$AppDatabase, $CachedPackingsTable> {
  $$CachedPackingsTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$CachedPackingsTableTableManager extends RootTableManager<
    _$AppDatabase,
    $CachedPackingsTable,
    CachedPacking,
    $$CachedPackingsTableFilterComposer,
    $$CachedPackingsTableOrderingComposer,
    $$CachedPackingsTableAnnotationComposer,
    $$CachedPackingsTableCreateCompanionBuilder,
    $$CachedPackingsTableUpdateCompanionBuilder,
    (
      CachedPacking,
      BaseReferences<_$AppDatabase, $CachedPackingsTable, CachedPacking>
    ),
    CachedPacking,
    PrefetchHooks Function()> {
  $$CachedPackingsTableTableManager(
      _$AppDatabase db, $CachedPackingsTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$CachedPackingsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$CachedPackingsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$CachedPackingsTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback: ({
            Value<String> name = const Value.absent(),
            Value<String?> description = const Value.absent(),
            Value<DateTime> createdAt = const Value.absent(),
...
typedef $$CachedPackingsTableProcessedTableManager = ProcessedTableManager<
    _$AppDatabase,
    $CachedPackingsTable,
    CachedPacking,
    $$CachedPackingsTableFilterComposer,
...
class $AppDatabaseManager {
  ...
  $$CachedPackingsTableTableManager get cachedPackings =>
      $$CachedPackingsTableTableManager(_db, _db.cachedPackings);
